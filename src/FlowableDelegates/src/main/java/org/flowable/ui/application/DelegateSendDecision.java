...
public class DelegateSendDecision implements JavaDelegate {
	...
	private I4_0_message[] choosedProposal_I4_0_messagbjects;
    ...
    public void execute(DelegateExecution execution) {
		...
		if (execution.getVariable("expectedMessageCounter",Integer.class) != 0){
			...
			try {
				...
				choosedProposal_I4_0_messagbjects = new I4_0_message[choosedProposalString.length];
			} catch (Exception e) {
			...
			for(I4_0_message answer : choosedProposal_I4_0_messagbjects){ 
